...
export default function ChatPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div
      className={`flex h-[80vh] max-h-none w-[92vw] max-w-[380px] origin-bottom-right flex-col overflow-hidden rounded-[28px] border border-white/40 bg-white/10 shadow-[0_8px_40px_rgba(0,0,0,0.25)] backdrop-blur-md transition-all duration-300 ease-out md:h-[80vh] md:max-h-160 ${
